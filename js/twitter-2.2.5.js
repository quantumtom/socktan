...
if (typeof TWTR !== 'undefined') {
	...
	elm.style.cssText = '-webkit-transition: all .5s linear;';

	if (!!elm.style.webkitTransitionProperty) { // is webkit and can transition

	var oldFade = TWTR.Widget.prototype._fade;

		TWTR.Widget.prototype._fade = function(el) {
