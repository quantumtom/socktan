define('data/home', function () {
  ...
  var homeData = {
    ...
    body_one: 'Socktan designs and builds original web sites for small businesses, non-profits, and other ' +
    'organizations. We also count artists and business professionals among our clients.',
    body_two: 'We operate in the sizable gap left between the amateur design shop and the larger corporate agencies. ' +
    ...
    body_three: 'Socktan is a group of skilled digital creatives working together to provide web-centric professional ' +
